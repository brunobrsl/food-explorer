...
export function AddProduct() {
  ...
  const imageUrl = useRef(productPlaceholder);
  ...
  async function handleNewProduct() {
    if (!imgFile) {
      return alert("Insira uma imagem para o produto.");
    }
    ...
    <Container>
      ...
      <Main>
        ...
        <Form onSubmit={formPreventDefault}>
          ...
          <Button className="submit-btn" title="Salvar alterações" onClick={handleNewProduct} />
        </Form>
      </Main>
